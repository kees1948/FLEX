 nam CMI_BUG cpuxxcmi monitor 4.3
 opt pag
 pag
...
*
fdccmd  equ     $e100   command register
fdctrk  equ     $e101   drive register
fdcsec  equ     $e102   sector register
fdcdat  equ     $e103   data register
fdcsel  equ     $e104   drive select
fdcsta  equ     $e108   drive status
*
D5INCH  equ     %01000000
...
*  $f8a1       $fe40      $e7c2     user-v
*  $f8a1       $fe42      $e7c4     swi3-v
*  $f8a1       $fe44      $e7c6     swi2-v
*  $f8a1       $fe46      $e7c8     firq-v
*  $f8a1       $fe48      $e7ca     irq-v
*  $fab0       $fe4a      $e7cc     swi-v
*  $ffff       $fe4c      $e7ce     svc-vo
*  $ffff       $fe4e      $e7d0     svc-vl
...
* report 60K of RAM, (I did not check it though)
        lda     #$56    fixed size for cpuxxcmi
...
***** "u" minidisk boot *****
minboot lda     #%00000001 select drive 0
        sta     cable      straight cable type
        sta     fdcsel
        jsr     Delay
        ldb     fdccmd      ready?
        bmi     set5        no
        bra     set1        yes
set5    lda     #%00000101 drive 0 not found
