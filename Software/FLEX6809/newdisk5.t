...
* **** **** **********
**************************************************
MAXTRK EQU 80 NUMBER OF TRACKS
* SINGLE DENSITY:
...
DSCMAP
 FCB 1,10,2,11,3,12,4,13,5,14,6,15,7,16,8,17,9,18
 FCB 19,29,20,30,21,31,22,32,23,33,24,34,26,35,27,36,28
* STRINGS
...
densf   fcb    %01100101        PC drive select 1 5"/SD/S0
