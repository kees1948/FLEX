...
minche        equ     $F806     with ech0
m_outch       equ     $F80A
m_tstat       equ     $F808
m_start       equ     $F800

*       abs  enable for relasmb
...
drvtrk  fcb     0,0             track for each drive
drvsec  fcb     0,0             disk type identifier
*
...
drv02   bsr     fndtrk          get current data in >X
        ...
        bsr     fndtrk          get data for new drive
...
stl00   ldb     curdrv
        beq     stl04
        ora     #%00001010      set lower 4 bits for drive select!
        bra     stl05
stl04   ora     #%00000101      set drive 0
stl05   sta     fo4lat
        sta     ltcopy
        puls    d,pc
...
r03     lda     <fo4sta
        ...
        bne     r03
        decb                    at zero dec B
        bne     r03             if zero abort
        bra     r98
*
r97     ldb     <fo2cmd        read status
        if      (WD2791=1)
        comb
        endif
*
...
r98     lda     #FD_FI0+8      force immediate interrupt
        if      (WD2791=1)
        coma
        endif
        sta     <fo2cmd
