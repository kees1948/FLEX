...
* Last modified 09-10-2024 CAJ

* extern pointers
FLEX  equ $CD00 FLEX cold start
prcnt equ $CC34 spooler
cable equ $F7EE cable type
...
HREAD equ $E200 -- READ JMP READ1 
HWRITE equ $E203 -- WRITE JMP WRITE1 
HVERIF equ $E206 -- VERIFY JMP VER1 
HREST equ $E209 -- RESTOR JMP REST1 
HSEL equ $E20C -- DRVSEL JMP DRVSL1 
HRDY equ $E20F -- CDRRDY JMP CDRR1 
QHRDY equ $E212 -- QDRRDY JMP CDRR1 
HCOLD equ $E215 -- DCOLDS JMP DCOLD 
...
BASADR EQU $F180 CPU09IDE board in CPUXXCMI system
...
*
TSKSET pshs Y  Speedup -23 cpu cycles
 pshs A save
 CLRA
