...
MINBOOT clr fdcsel
 ...
 bne NoDel Reboot
 ldab #3 GoTek PowerOn delay 12MHz card
 jsr Pdelay
...
PUNCH CLR BTEMP CLEAR RESERVED BYTE
 ...
 cpx YTEMP with XTEMP already in X-reg.
 beq PUNEXT LOW = HIGH
 ldaa XTEMP+1 HIGH ADDRESS
 cmpa YTEMP+1 LOW ADDRESS
 ldab XTEMP
 sbcb YTEMP
 bcc pun1 LOW < HIGH
PUNEXT rts LOW = HIGH, LOW > HIGH
pun1 inx
...
PUNCHL ADDB ,X ADD DATA BYTE TO CHECKSUM
 ...
 CPX XTEMP COMPARE IT TO END ADDR
 beq punche EXIT
 ldaa XTEMP+1 TEST FOR 100%
 cmpa YTEMP+1
 ldab XTEMP
 sbcb YTEMP
 bcc PUNCH2 NOT DONE YET
punche LDAA #$14 LOAD 'DC4' PUNCH OFF CODE
 JSR OUTCH OUTPUT IT
 RTS
